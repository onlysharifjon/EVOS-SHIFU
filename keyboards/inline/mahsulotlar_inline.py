...
lavash_3 = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            InlineKeyboardButton(text="Mini 25 000 so'm", callback_data="Mol_go'shtidan_pishloqli_lavash_Standar_Mini"),
            InlineKeyboardButton(text="Big 29 000 so'm", callback_data="Mol_go'shtidan_pishloqli_lavash_Standar_Big"),
        ],

    ]
)

lavash_4 = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            InlineKeyboardButton(text="Mini 23 000 so'm", callback_data="Lavash_cheese_tovuq_go'sht_Standart_Mini"),
            InlineKeyboardButton(text="Big 27 000 so'm", callback_data="Lavash_cheese_tovuq_go'sht_Standart_Big"),
        ],
...
lavash_6 = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            InlineKeyboardButton(text="Mini 20 000 so'm", callback_data="Lavash_tovuq_go'sht_Mini"),
            InlineKeyboardButton(text="Big 24 000 so'm", callback_data="Lavash_tovuq_go'sht_Big"),
        ],

    ]
)

lavash_7 = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            InlineKeyboardButton(text="Mini 22 000 so'm", callback_data="Lavash_mol_go'sht_Mini"),
            InlineKeyboardButton(text="Big 26 000 so'm", callback_data="Lavash_mol_go'sht_Big"),
        ],

    ]
)

shaurma_1 = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            InlineKeyboardButton(text="Mini 22 000 so'm", callback_data="Shaurma_qalampir_mol_go'sht_Mini"),
            InlineKeyboardButton(text="Big 26 000 so'm", callback_data="Shaurma_qalampir_mol_go'sht_Big"),
        ],

    ]
)
shaurma_2 = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            InlineKeyboardButton(text="Mini 21 000 so'm", callback_data="Shaurma_ovuq_go'sht_Mini"),
            InlineKeyboardButton(text="Big 24 000 so'm", callback_data="Shaurma_ovuq_go'sht_Big"),
        ],

    ]
)

shaurma_3 = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            InlineKeyboardButton(text="Mini 21 000 so'm", callback_data="Shaurma_qalampir_tovuq_go'sht_Mini"),
            InlineKeyboardButton(text="Big 24 000 so'm", callback_data="Shaurma_qalampir_tovuq_go'sht_Big"),
        ],

    ]
)

shaurma_4 = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            InlineKeyboardButton(text="Mini 22 000 so'm", callback_data="Shaurma_mol_go'sht_Mini"),
            InlineKeyboardButton(text="Big 26 000 so'm", callback_data="Shaurma_mol_go'sht_Big"),
        ],
